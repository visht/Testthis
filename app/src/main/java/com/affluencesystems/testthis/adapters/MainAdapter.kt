package com.affluencesystems.testthis.adapters
...
class MainAdapter(context: Context, list: List<User>) :
     ...
     * update the contents of the [Holder.itemView] to reflect the item at the given
     * position.
     *
     *
     ...
     * on (e.g. in a click listener), use [Holder.getAdapterPosition] which will
